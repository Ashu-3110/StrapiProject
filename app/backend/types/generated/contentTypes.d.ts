...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    ProductFlavor: Attribute.String;
    ...
    >;
    product_size_cost: Attribute.Relation<
      'api::product.product',
      'oneToMany',
      'api::product-size-cost.product-size-cost'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiProductSizeCostProductSizeCost
  extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::product-size-cost.product-size-cost': ApiProductSizeCostProductSizeCost;
    }
  }
}
